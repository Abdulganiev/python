...
select distinct
   ...
   from uszn.v_coll_membership_periods pc
     ...
     on pc.coll_id=pic1.coll_id and pc.region_id=pic1.region_id
         ...
         and trunc(to_date('01.01.2024'), 'mm') between pic1.date_start and pic1.date_end and pic1.role_class_id=8
        left join uszn.v_coll_membership_periods pic2
     on pc.coll_id=pic2.coll_id and pc.region_id=pic2.region_id
         and trunc(to_date('01.01.2024'), 'mm') between pic2.date_start and pic2.date_end and pic2.role_class_id=9
   ...
   where pc.region_id in (58,59,60,61,62,63,64,65,66,67,68,69,70)
         ...
         and trunc(to_date('01.01.2024'), 'mm') between pc.date_start and pc.date_end
