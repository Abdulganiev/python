...
(select uszn.ToDateISODef(nvl(uszn.pkXMLImp.GetTagValueByName(death.id, 'ДатаРождКаленд', 0, 0), uszn.pkXMLImp.GetTagValueByName(death.id, 'ДатаРожд', 0, 0)))
  from uszn.r$_parsed_xml_data sved inner join uszn.r$_parsed_xml_data death on death.owner_id=sved.id and death.name='СведУмер'
...
(select uszn.ToDateISODef(nvl(uszn.pkXMLImp.GetTagValueByName(death.id, 'ДатаСмерт', 0, 0), uszn.pkXMLImp.GetTagValueByName(death.id, 'ДатаСмертКаленд', 0, 0)))
  from uszn.r$_parsed_xml_data sved inner join uszn.r$_parsed_xml_data death on death.owner_id=sved.id and death.name='СведУмер'
...
(select nvl(uszn.pkXMLImp.GetTagValueByName(death.id, 'ДатаСмерт', 0, 0), uszn.pkXMLImp.GetTagValueByName(death.id, 'ДатаСмертКаленд', 0, 0))
  from uszn.r$_parsed_xml_data sved inner join uszn.r$_parsed_xml_data death on death.owner_id=sved.id and death.name='СведУмер'
