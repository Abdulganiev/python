select
    distinct t1.pc_region_id,
             uszn.pkTSrv.GetRegionName(t1.pc_region_id) as mo,
             t1.pc_region_id||'-'||t1.pc_id as pc_id,
             uszn.pkPerson.DescribeManColl(t1.pc_region_id, t1.pc_id, 0) as pc_desc,
             uszn.pkPerson.GetPersonalReq(t1.pc_region_id, t1.pc_id, 25) as SNILS
 ...
 order by uszn.pkPerson.GetPersonalReq(t1.pc_region_id, t1.pc_id, 25)