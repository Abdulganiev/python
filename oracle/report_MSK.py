...
def report_MSK():
    ...
    try:
        curs.execute('DROP TABLE uszn.temp$_msk_resh')
    except:
        pass

    try:
        curs.execute('''create table uszn.temp$_msk_resh as
(select
  region_id,
...
from
  (select region_id,
             ...
             uszn.pkPerson.GetDocReqValue(region_id, 7793, doc_instance_id) as data_obr,
             uszn.pkPerson.GetDocReqValue(region_id, 7799, doc_instance_id) as data_resh,
             uszn.pkPerson.GetDocReqValue(region_id, 7795, doc_instance_id) as vid_resh,
             uszn.pkPerson.GetDocReqValue(region_id, 7796, doc_instance_id) as summa_resh,
   ...
   select region_id,
             ...
             uszn.pkPerson.GetDocReqValue(region_id, 7773, doc_instance_id) as data_obr,
             uszn.pkPerson.GetDocReqValue(region_id, 7777, doc_instance_id) as data_resh,
             uszn.pkPerson.GetDocReqValue(region_id, 7782, doc_instance_id) as vid_resh,
             uszn.pkPerson.GetDocReqValue(region_id, 7783, doc_instance_id) as summa_resh,
   ...
   select region_id,
            ...
            uszn.pkPerson.GetDocReqValue(region_id, 9066, doc_instance_id) as data_obr,
            uszn.pkPerson.GetDocReqValue(region_id, 9077, doc_instance_id) as data_resh,
            uszn.pkPerson.GetDocReqValue(region_id, 9069, doc_instance_id) as vid_resh,
            uszn.pkPerson.GetDocReqValue(region_id, 9070, doc_instance_id) as summa_resh,
   ...
   select region_id,
             ...
             uszn.pkPerson.GetDocReqValue(region_id, 17404, doc_instance_id) as data_obr,
             uszn.pkPerson.GetDocReqValue(region_id, 17417, doc_instance_id) as data_resh,
             uszn.pkPerson.GetDocReqValue(region_id, 17409, doc_instance_id) as vid_resh,
             uszn.pkPerson.GetDocReqValue(region_id, 17410, doc_instance_id) as summa_resh,
    ...
    curs.execute('SELECT count(*) FROM uszn.temp$_msk_resh')
